...
def _prompt(latin_name, n_refs):
    ...
    return (
        ...
        f"- A physically solid, continuous body. It must never intersect, clip "
        f"through or pass into itself or another limb -- where a snake or a tail "
        f"coils or overlaps, one part rests convincingly on top of the other, "
        f"never merging or tunnelling through it.\n"
